...
pub fn create_cactus_command() -> Command {
    command!("cactus",
        ...
        "docs" => handler!(|_context, _api, _text, _action| {
            Context::message(vec! [
        ...
        "twitter" => handler!(|_context, _api, _text, _action| {
            Context::message(vec! [
        ...
        "help" => handler!(|_context, _api, _text, _action| {
            Context::message(vec! [
        ...
        "github" => handler!(
            ...
            "issue" => handler!(|_context, _api, _text, _action| {
                Context::message(vec! [
